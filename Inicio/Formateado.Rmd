...
```{r}
dataset=read.csv("dataset_2024.csv",sep = ";")
asignaturas=read.csv("asignaturas_2024.csv",sep=";")
titulaciones=read.csv("titulaciones_2024.csv",sep=";")
estudiantes=read.csv("estudiantes_2024_rev.csv",sep=";")
head(dataset)
```
...
save(dataset_ordenado,file="Inicial_completo.Rdata")
write.csv(dataset_ordenado,file="inicial.csv")

save(informatica,file="informatica.Rdata")
write.csv(informatica, file="informatica_inicial.csv")
rm(list = ls())
```
